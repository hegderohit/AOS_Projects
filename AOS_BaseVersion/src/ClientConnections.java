...
boolean flag=true;
	...
	public void run() {
		...
		for (int i = 0; i < MainClass.nodeCount; i++) {
			ByteBuffer byteBuffer;
			byteBuffer = ByteBuffer.allocate(512);
			int port = MainClass.portNumerList.get(i);
			String host = MainClass.domainNameList.get(i);
			...
			try {
				...
				/*MessageInfo messageInfo = ClientSock.receive(byteBuffer, null,
						null);
				String message = MainClass.byteToString(byteBuffer);
